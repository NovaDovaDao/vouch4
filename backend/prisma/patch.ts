...
const runtimeJsFilePath = join(
  __dirname,
  "./generated/client/runtime/library.js"
);
const runtimeCjsFilePath = join(
  __dirname,
  "./generated/client/runtime/library.cjs"
);
...
try {
  ...
  const updatedDtsContent = dtsFileContent.replace(
  ...
  const updatedCjsContent = cjsFileContent.replace(
